...
/**
 * RFG Executivo, Anexo 1 - Despesa Total com Pessoal - COFRON
 *
 * @author Everton
 */
final class A1CofronDtp extends RgfBase {

    public function __construct(Db $con, Spreadsheet $spreadsheet, int $remessa) {
        parent::__construct('RGF A1 COFRON', $con, $spreadsheet, $remessa);
    }
