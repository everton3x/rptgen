...
final class A3Rcl extends RreoBase {
    ...
    protected function getCellMap(): array {
        return [           
            ...
            'C41' => $this->emendas(3110, 11) + $this->emendas(3111, 11),
            'D41' => $this->emendas(3110, 10) + $this->emendas(3111, 10),
            'E41' => $this->emendas(3110, 9) + $this->emendas(3111, 9),
            'F41' => $this->emendas(3110, 8) + $this->emendas(3111, 8),
            'G41' => $this->emendas(3110, 7) + $this->emendas(3111, 7),
            'H41' => $this->emendas(3110, 6) + $this->emendas(3111, 6),
            'I41' => $this->emendas(3110, 5) + $this->emendas(3111, 5),
            'J41' => $this->emendas(3110, 4) + $this->emendas(3111, 4),
            'K41' => $this->emendas(3110, 3) + $this->emendas(3111, 3),
            'L41' => $this->emendas(3110, 2) + $this->emendas(3111, 2),
            'M41' => $this->emendas(3110, 1) + $this->emendas(3111, 1),
            'N41' => $this->emendas(3110, 0) + $this->emendas(3111, 0),
            
            'C43' => $this->emendas(3120, 11) + $this->emendas(3121, 11),
            'D43' => $this->emendas(3120, 10) + $this->emendas(3121, 10),
            'E43' => $this->emendas(3120, 9) + $this->emendas(3121, 9),
            'F43' => $this->emendas(3120, 8) + $this->emendas(3121, 8),
            'G43' => $this->emendas(3120, 7) + $this->emendas(3121, 7),
            'H43' => $this->emendas(3120, 6) + $this->emendas(3121, 6),
            'I43' => $this->emendas(3120, 5) + $this->emendas(3121, 5),
            'J43' => $this->emendas(3120, 4) + $this->emendas(3121, 4),
            'K43' => $this->emendas(3120, 3) + $this->emendas(3121, 3),
            'L43' => $this->emendas(3120, 2) + $this->emendas(3121, 2),
            'M43' => $this->emendas(3120, 1) + $this->emendas(3121, 1),
            'N43' => $this->emendas(3120, 0) + $this->emendas(3121, 0),
            ...
            'P41' => $this->previstoEmendas(3110) + $this->previstoEmendas(3111),
            'P43' => $this->previstoEmendas(3120) + $this->previstoEmendas(3121),
